<?php
	...
	*/
	...
	define('GALLERY_ROOT', './camera/');
	define('DATA_ROOT', './_sfpg_data/');
	define('SECURITY_PHRASE', 'LoB_secure_phrase'); # LoB
	define('PASSWORD', '');
	define('ADMIN', TRUE); # LoB
	...
	define('SHOW_IMAGE_EXT', TRUE); # LoB
	define('IMAGE_SORT_REVERSE', TRUE); # LoB
	define('IMAGE_SORT_BY_TIME', TRUE); # LoB
	...
	define('DESC_EXT', '.txt');
	define('DESC_NL_TO_BR', TRUE); # LoB
	define('SORT_DIVIDER', '--');
	define('SORT_ALL_NATURAL', TRUE);
	define('FONT_SIZE', 14); # LoB
	define('UNDERSCORE_AS_SPACE', TRUE); # LoB
	...
	define('TEXT_GALLERY_NAME', 'BigBro Gallery');
	define('TEXT_BANNER', '');
